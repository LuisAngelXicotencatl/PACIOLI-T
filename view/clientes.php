    ...
    <div class="flex items-center justify-center space-x-4 flex-wrap">
        ...
        ?>
            <div class="bg-yellow-500 p-4 rounded-lg mb-4">
                ...
                <a href="clienteinfo.php?id=<?php echo $infoCliente["usuario"]; ?>" class="inline-block"><button class="bg-gray-900 text-white px-4 py-2 rounded">Informacion del cliente</button></a>
            </div>
        <?php
        }
        ?>
