...
<body>
    ...
    <section id="nosotros" class="bg-gray-100 py-8 md:py-16">
        ...
        <a href="../controller/citaeliminarEM.php?id=<?php echo $row['id_cita'];?>" class="inline-block"><button class="bg-gray-900 text-white px-4 py-2 rounded">Eliminar cita</button></a>
        <?php } ?>
    </section>
    <!-- footer--->
